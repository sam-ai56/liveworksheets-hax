...
Is just a little hack for liveworksheets

### How is it work?

liveworksheets uploads the answers to the client with which we can retrieve this data and put it into the fields... that's it.
